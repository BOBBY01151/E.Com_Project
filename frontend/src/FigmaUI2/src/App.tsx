...
import { User, Home, ShoppingBag, Info, Mail, ShoppingCart, Ruler } from "lucide-react";

export default function App() {
  const [currentPage, setCurrentPage] = useState<'home' | 'profile' | 'shop' | 'about' | 'contact' | 'cart' | 'size-guide'>('home');
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="fixed top-20 right-4 z-40 flex flex-col gap-2">
        ...
        <Button
          ...
          variant={currentPage === 'size-guide' ? 'default' : 'outline'}
          size="sm"
          className="shadow-lg"
        >
