...
import { Ruler, ShirtIcon, Footprints, ArrowDown } from "lucide-react";
...
export function SizeGuidePage() {
  ...
  const tshirtSizes = [
    { size: "XS", chest: "32-34", length: "26", shoulder: "15.5" },
    { size: "S", chest: "35-37", length: "27", shoulder: "16.5" },
    { size: "M", chest: "38-40", length: "28", shoulder: "17.5" },
    { size: "L", chest: "41-44", length: "29", shoulder: "18.5" },
    { size: "XL", chest: "45-48", length: "30", shoulder: "19.5" },
    { size: "XXL", chest: "49-52", length: "31", shoulder: "20.5" }
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-screen overflow-hidden bg-black text-white">
        ...
        <div className="absolute inset-0">
          <div 
            className="absolute inset-0 parallax-element opacity-40"
            style={{ 
          ...
          />
          <div 
            className="absolute inset-0 parallax-element opacity-30"
            style={{ 
        ...
        <div className="relative flex items-center justify-center min-h-screen px-4 z-10">
          <div className="text-center max-w-4xl">
            ...
            >
              <div className="inline-flex items-center gap-4 mb-6 p-4 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
                ...
                <div className="text-left">
                  ...
                  <h1 className="text-5xl md:text-7xl">Size Guide</h1>
                </div>
              </div>
            </motion.div>
            ...
            >
              Discover your perfect fit with our comprehensive sizing charts for shoes, denim, and t-shirts. 
      ...
      <div className="relative bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl mb-4">Find Your Perfect Fit</h2>
          ...
          <Tabs defaultValue="shoes" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-12 bg-gray-100 h-16">
              ...
              <TabsTrigger value="tshirts" className="flex items-center gap-2 data-[state=active]:bg-black data-[state=active]:text-white h-full text-base">
                <ShirtIcon className="w-5 h-5" />
                T-Shirts
              </TabsTrigger>
            </TabsList>
              ...
              >
                ...
                <Card className="border-2 border-gray-100 hover:shadow-xl transition-shadow duration-300">
                  ...
                  <CardContent className="p-6 space-y-6">
                    ...
                    >
                      <h4 className="mb-3">Fitting Tips</h4>
            ...
            <TabsContent value="denim" className="space-y-8">
              ...
              >
                      ...
                      <table className="w-full">
                        <thead>
                          <tr className="border-b-2 border-gray-200">
                            ...
                            <th className="text-left py-3 font-medium">Hip (inches)</th>
                            <th className="text-left py-3 font-medium">Inseam (inches)</th>
                          </tr>
                        </thead>
                        <tbody>
                          {denimSizes.map((size, index) => (
                            <motion.tr 
                              ...
                              className="border-b border-gray-100 hover:bg-gray-50 transition-colors"
                            >
                              <td className="py-3">{size.size}</td>
                              <td className="py-3">{size.waist}</td>
                              <td className="py-3">{size.hip}</td>
                              <td className="py-3">{size.inseam}</td>
                            </motion.tr>
                          ))}
                        </tbody>
                      </table>
                ...
                <Card className="border-2 border-gray-100 hover:shadow-xl transition-shadow duration-300">
                  <CardHeader className="bg-gradient-to-r from-gray-50 to-white">
                    <CardTitle>How to Measure for Denim</CardTitle>
                  </CardHeader>
                  <CardContent className="p-6 space-y-6">
                    <div className="space-y-4">
                      {[
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-gray-600">{measurement.desc}</p>
                          </div>
                        </motion.div>
                      ))}
                    </div>
                    ...
                    <motion.div 
                      ...
                      className="p-6 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl"
                    >
                      <h4 className="mb-4">Denim Fit Guide</h4>
                      <div className="grid grid-cols-2 gap-4">
                        {[
                          ...
                          <div key={index}>
                            <p className="font-medium text-black">{fit.name}</p>
                            <p className="text-gray-600">{fit.desc}</p>
                          </div>
                        ))}
                      </div>
                    </motion.div>
            ...
            {/* T-Shirts Tab */}
            <TabsContent value="tshirts" className="space-y-8">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              >
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full">
                        <thead>
                          <tr className="border-b-2 border-gray-200">
                            <th className="text-left py-3 font-medium">Size</th>
                            <th className="text-left py-3 font-medium">Chest (inches)</th>
                            <th className="text-left py-3 font-medium">Length (inches)</th>
                            <th className="text-left py-3 font-medium">Shoulder (inches)</th>
                          </tr>
                        </thead>
                        <tbody>
                ...
                <Card className="border-2 border-gray-100 hover:shadow-xl transition-shadow duration-300">
                  <CardHeader className="bg-gradient-to-r from-gray-50 to-white">
                    <CardTitle>How to Measure for T-Shirts</CardTitle>
                  </CardHeader>
                  <CardContent className="p-6 space-y-6">
                    <div className="space-y-4">
                      {[
                        ...
                        { title: "Shoulder", desc: "Measure from shoulder point to shoulder point" }
                      ].map((measurement, index) => (
                        <motion.div 
                          key={index}
                          initial={{ opacity: 0, x: -20 }}
                    ...
                    <motion.div 
                      ...
                      className="p-6 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl"
                    >
                      <h4 className="mb-4">T-Shirt Fit Guide</h4>
                      <div className="space-y-3">
                        {[
                          ...
                          <div key={index} className="flex justify-between">
                            <span className="font-medium text-black">{fit.name}:</span>
                            <span className="text-gray-600">{fit.desc}</span>
                          </div>
                        ))}
                      </div>
                    </motion.div>
          ...
          >
            <Card className="bg-gradient-to-br from-black to-gray-800 text-white border-0 hover:scale-105 transition-transform duration-300">
              <CardContent className="p-8 text-center">
                <Ruler className="w-12 h-12 mx-auto mb-6" />
            ...
            <Card className="border-2 border-gray-100 hover:scale-105 transition-transform duration-300">
              <CardContent className="p-8 text-center">
                <div className="w-12 h-12 bg-black text-white rounded-full flex items-center justify-center mx-auto mb-6">
                  ↺
                </div>
                <h3 className="mb-4">Easy Returns</h3>
            ...
            <Card className="border-2 border-gray-100 hover:scale-105 transition-transform duration-300">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="mb-4">Size Guarantee</h3>
                <p className="text-gray-600">
